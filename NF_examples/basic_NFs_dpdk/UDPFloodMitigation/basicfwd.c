...
if (((*(int*) f.headers[Udp]) == _t2)&&(udpflood[f][(*(IP*) f.headers[Sip])] != _t3 && udpcounter[f][(*(IP*) f.headers[Sip])] != threshold[f])){
udpcounter[f][(*(IP*) f.headers[Sip])]=udpcounter[f][(*(IP*) f.headers[Sip])] + _t4;
}
else if (((*(int*) f.headers[Udp]) == _t5)&&(udpflood[f][(*(IP*) f.headers[Sip])] != _t6 && udpcounter[f][(*(IP*) f.headers[Sip])] == threshold[f])){
return -1;
udpflood[f][(*(IP*) f.headers[Sip])]=_t7;
}
else if ((*(int*) f.headers[Udp]) != _t8){
}
        f.clean();
        return 0;
}
